...
public class Main {
    ...
    /**
     * String => Nhap chuoi nextLine, next String có rất nhiều hàm hỗ trợ 1.
     * Laydo dai cua String => length : Lay do dai cua 1 chuoi 2. Ghep chuoi =>
     * + => concat 3. So sanh => == => compareTo(Phan biet hoa thuong) =>
     * compareToIgnoreCase ( Khong phan biet hoa thuong) => equals : Phan biet
     * hoa thuong => equalsIgnoreCase : Khong phan biet hoa thuong 4. Kiem tra
     * chua : Kiem chuõi 1 có chứa chuõi 2 không => contains: co phan biet hoa
     * thuong 5. Viet hoa het : toUpperCase 6.Viet thuong het: toLowerCase
     */
